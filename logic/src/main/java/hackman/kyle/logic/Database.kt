...
object Database {
    ...
    val questions: List<Question> = listOf(
        ...
        Question(
            "question5",
            "You are starting to match opponents of a higher level and notice your opponent’s weaknesses. You are beginning to dictate some of the aspects of the game. You have proactive moments rather than being constantly reactive."
        ),
        Question(
            "question6",
